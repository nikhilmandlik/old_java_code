<!-- 
* Class Name                     : PaymentReportMCForm.jsp
...
%>
	...
	<table align="center" width="50%">		
		<tr align="center"><td><A href="PaymentsReportMC.jsp">Paid Payment Reports</A></td></tr>
		<tr align="center"><td><A href="PendingPaymentsReportMC.jsp">Pending Payment Reports</A></td></tr>		
	</table>
<%	}
%>
