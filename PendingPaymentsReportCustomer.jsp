<!-- 
* Class Name                     : PendingPaymentsReportCustomer.jsp
...
<% 
	...
	<A Href="Logout.jsp">Logout</A>
		...
		<form name="ReportForm" action="PendingPaymentReport.jsp">
			<h1 class="heading1" align="center">Sterling Courier</h1>
		
			<table align="center" width="500">
				<tr>
					<th align="center" colspan="3" class="heading3">Pending Payment Report
					</th>
				</tr>		
				<tr>
					<td Width="30%">
