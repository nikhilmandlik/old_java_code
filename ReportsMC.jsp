...
%>
	...
	<table align="center" width="60%"><br><br>
	<tr>
	...
	<tr><td align="center"><a href="DeliveryHistoryForm.jsp">Generate Delivery History</td></tr>
	<tr><td align="center"><a href="OrderAssignedReportForm.jsp">Generate Assignment Report</td></tr>
	<tr><td align="center"><a href="CustomerReportForm.jsp">Generate Customer Report</td></tr>
	<tr><td align="center"><a href="InvoiceReportM&C.jsp">Invoice Report</td></tr>
	<tr><td align="center"><a href="PaymentReportMCForm.jsp">Payment Report</td></tr>
	</table>
<%	}
%>
